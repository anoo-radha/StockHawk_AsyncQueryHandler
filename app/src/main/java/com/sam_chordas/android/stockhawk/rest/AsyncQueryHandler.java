...
/**
 * modified from https://gist.github.com/b22n/5954228
 */
        ...
        public void handleMessage(Message msg) {
            ...
            switch (event) {
                ...
                case EVENT_ARG_BULK_INSERT:
                    Log.i("AsyncQueryHandler","in EVENT_ARG_BULK_INSERT");
//                    args.result = resolver.bulkInsert(args.uri, args.values);
                    try {
                        args.result = resolver.applyBatch(args.authority, args.batchOperations);
                    } catch (RemoteException | OperationApplicationException e) {
                        Log.e("AsyncQueryHandler", "Error applying batch insert", e);
                    }
                    break;
...
//        mWorkerThreadHandler.sendMessage(msg);
//    }
    public final void startBulkInsert(int token, Object cookie, String authority, ArrayList<ContentProviderOperation> batchOperations) {
        Message msg = mWorkerThreadHandler.obtainMessage(token);
        msg.arg1 = EVENT_ARG_BULK_INSERT;
